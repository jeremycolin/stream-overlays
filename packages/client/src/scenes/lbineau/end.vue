...
import backgroundUrl from "/isaac/end/isaac-ending.mp4";
...
export default {
  ...
  async mounted() {
    ...
    if (texture.baseTexture.resource?.source) texture.baseTexture.resource.source.loop = true;
